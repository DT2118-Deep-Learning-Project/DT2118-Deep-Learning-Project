"""
 Original: https://github.com/sdierauf/tiny-imagenet-classifier/blob/master/plotting_utils.py
...
class PlotGenerator(object):
    ...
    def update(self, epoch, train_loss, val_loss):
        ...
        Args:
            ...
            val_loss: All of the validation loss values of each
                epoch (list of floats).
        """
        self._redraw_plot(epoch, train_loss, val_loss)
    ...
    def _redraw_plot(self, epoch, train_loss, val_loss):
        """
        Redraws the plot with new values.
        Don't plot accuracy
        Args:
