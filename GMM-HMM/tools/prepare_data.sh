...
# 
# Modificated version - For the project related to the class
# Take the name of the specific path for the tidigits
# 2016 Eric Masseran 
...
find ../data/$1/train/ -name "*.wav" > workdir/train.lst
recho "...create list of test files"
find ../data/$1/test/ -name "*.wav" > workdir/test.lst
